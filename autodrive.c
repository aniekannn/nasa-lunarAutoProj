...
void move_forward() {
  //wheels are moving in a clockwise direction
  delay(10);
...
void move_right() {
   // right wheels stop & left wheels move
  delay(10);
  digitalWrite(front_leftIN1, HIGH);
  digitalWrite(front_leftIN2, LOW);
  digitalWrite(front_rightIN1, LOW);
...
void move_left() {
   // left wheels stop & right wheels move
   delay(10);
  digitalWrite(front_leftIN1, LOW);
  digitalWrite(front_leftIN2, LOW);
  digitalWrite(front_rightIN1, HIGH);
